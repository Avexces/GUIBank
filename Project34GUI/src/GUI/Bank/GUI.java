 ...
 public class GUI {
     ...
     private static void Select_Bills(int selectedmoney) {
         ...
         if (selectedmoney == 70) {
             ...
             //2de optie
             JLabel biljet10 = new JLabel(" 10$ Note       Number: 2");
             ...
             JLabel biljet20 = new JLabel(" 20$ Note       Number: 0");
         ...
         if (balans >= bedrag) {
             ...
             if (bedrag == 70) {
                 ...
                 if (brief10 == 2) {
                     ...
                     aantalvijftig -=1;
                     try {
                         geld10 = new URL("http://145.24.222.162/db_connection.php?query=UPDATE+Biljetten+SET+aantal+%3D");
                         geld50 = new URL("");
                     } catch (MalformedURLException a) {
                         a.printStackTrace();
                     }
